...
Bevor wir uns an das Anpassungswerkzeug heran wagen, klicken Sie [hier](https://kb.dataent.io/kb/customization/form-architecture) um den Aufbau von Formularen in EPAAS zu verstehen. Das soll Ihnen dabei helfen das Anpassungswerkzeug effektiver zu nutzen.
...
![Formular anpassen - Listenansicht](/docs/assets/old_images/epaas/customize-form-list-view.png)
...
![Formular anpassen - Dokument](/docs/assets/old_images/epaas/customize-form-document.png)
...
![Formular anpassen - Zwingend erfoderliche Angaben](/docs/assets/old_images/epaas/customize-form-mandatory.png)
...
![Formular anpassen - Aktualisieren](/docs/assets/old_images/epaas/customize-form-update.png)
...
<table border="1" width="700px">
  <tbody>
    ...
    <tr>
      <td>Feldtyp</td>
      <td>Klicken Sie <a href="/docs/user/manual/en/customize-epaas/articles/field-types">hier</a> um mehr über Feldtypen zu erfahren.</td>
    </tr>
    <tr>
      <td>Optionen</td>
