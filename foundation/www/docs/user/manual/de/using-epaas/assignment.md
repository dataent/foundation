...
Die Option "Zuweisen zu" in EPAAS erlaubt es Ihnen ein bestimmtes Dokument einem Benutzer, der weiter an diesem Dokument arbeiten soll, zu zu weisen.
...
![Symbol für Zuweisung](/docs/assets/old_images/epaas/assigned-to-icon.png)

![Zugewiesen zu](/docs/assets/old_images/epaas/assigned-to.png)
