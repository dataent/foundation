...
Financial statements for your company are easily viewable in EPAAS. You can view financial statements
...
To edit your Chart of Accounts in EPAAS go to:

>  Accounts > Setup > Chart of Accounts

Chart of Accounts is a tree view of the names of the Accounts (Ledgers and
Groups) that a Company requires to manage its books of accounts. EPAAS sets
...
In EPAAS it is easy to create a Profit and Loss analysis chart. An example
...
There are two main kinds of Accounts in EPAAS - Group and Ledger. Groups can
...
In EPAAS, you can also specify more information when you create a new
...
EPAAS creates a standard structure for you when the Company is created but
