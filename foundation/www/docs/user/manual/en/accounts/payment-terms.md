<!-- add-breadcrumbs -->
# Payment Terms
You can save your business' payment terms on EPAAS and include it in all documents in the sales/purchase cycle and EPAAS will make all the proper general ledger entries accordingly.
...
Payment Terms Template tells EPAAS how to populate the table in the Payment Terms Schedule section of the sales/purchase document.
