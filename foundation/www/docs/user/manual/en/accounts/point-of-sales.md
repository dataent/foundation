...
POS Invoices created in the offline mode will be saved locally in the browser. If internet connection is lost which creating POS Invoice, you will still be able can proceed forward. Once internet connection is available again, offline invoices will be synced, and pushed onto your EPAAS account. To learn more on how POS Invoices can be created when offline, [check here.](https://dataent.io/blog/blog/epaas-features/offline-pos-in-epaas-7)

#### POS Profile

In EPAAS all Sales and Purchase transactions, like Sales Invoice, Quotation, Sales Order, Purchase Order etc. can be edited via the POS. There two steps to Setup POS:
