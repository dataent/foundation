...
EPAAS will automatically create new Invoices and mail it to the Email Addresses
you set.

#### Automatically Fetching Item Batch Numbers

If you are selling an item from a [Batch](/docs/user/manual/en/stock/batch),
EPAAS will automatically fetch a batch number for you if "Update Stock" 
...
no batch that can satisfy the order, EPAAS will cancel its attempt to automatically 
...
EPAAS) titled as “Pro Forma Invoice”. This way everyone is happy.
