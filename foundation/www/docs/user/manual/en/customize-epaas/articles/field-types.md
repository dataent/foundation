...
Since EPAAS has multiple column layout, using Column Breaks, you can divide set of fields side-by-side. 
...
Click [here](/docs/user/manual/en/customize-epaas/articles/managing-dynamic-link-fields.html) to learn how Dynamic Link Field function.
...
Text Editor is text field. It has text-formatting options. In EPAAS, this field is generally used for defining Terms and Conditions.
