...
Click [here](/docs/user/manual/en/customize-epaas/articles/module-visibility.html) to learn about other features from where icons from the desktop can be hidden.
