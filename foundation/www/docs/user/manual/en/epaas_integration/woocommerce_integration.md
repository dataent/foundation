...
#### Setting Up WooCommerce on EPAAS:-
...
4. In "Woocommerce Server URL" paste the url of your site where EPAAS is installed.
...
<img class="screenshot" alt="Woocommerce Integration" src="{{docs_base_url}}/assets/img/epaas_integrations/woocommerce_setting_config.gif">
...
8. Now on system where EPAAS is installed check the following doctypes: Customer, Address, Item, Sales Order.

<img class="screenshot" alt="Woocommerce Integration" src="{{docs_base_url}}/assets/img/epaas_integrations/woocommerce_demo.gif">