...
##### SMS Alerts
You can configure EPAAS Healthcare to alert Patients via SMS when the Lab Test result gets ready (Submit) and when you Email the result. You an configure the templates for the SMS as registered with your provider here.
...
###### Result Format
Following are the result formats available in EPAAS Healthcare
