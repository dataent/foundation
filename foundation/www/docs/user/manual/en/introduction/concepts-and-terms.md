...
is used and some basic concepts in EPAAS.
...
This represents the Company records for which EPAAS is setup. With this same
...
“Supplier Mae” are accounts. EPAAS creates accounts for Customers and
...
Credits of those entries is the same. In EPAAS you can update Payments,
...
EPAAS allows you to book transactions in multiple currencies. There is only
...
A request made by a system User, or automatically generated by EPAAS based
...
from the EPAAS website module. Blog is a short form of “Web Log”.
...
> Setup > Customize EPAAS > Custom Field
