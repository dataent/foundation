...
### Test Phase
  ...
  * Read the Manual
  * Create a free account at [https://epaas.com](https://epaas.com) (the easiest way to experiment).
...
Once you are familiar with EPAAS, start entering your live data!
  ...
  * You can also setup a new account at [https://epaas.com](https://epaas.com), and use the 30-day free trial. [Find out more ways of deploying EPAAS](docs/user/manual/en/introduction/getting-started-with-epaas)
  ...
  * If you need help, [you can buy support](https://epaas.com/pricing) or [ask in the user forum](https://discuss.epaas.com).
