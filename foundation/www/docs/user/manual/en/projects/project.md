...
Project management in EPAAS is Task driven. You can create Project and assign multiple Tasks against it.
...
EPAAS uses [Time Log](/docs/user/manual/en/projects/time-log.html) to track the progress of a Project.
...
EPAAS gives you a illustrated view of tasks scheduled against that project in Gantt Chart View.
