...
Data in EPAAS is stored in tables, much like a spreadsheet with columns and
rows of data. Each entity in EPAAS can have multiple child tables associated
...
EPAAS also allows you to overwrite all / certain columns. If you want to
...
EPAAS restricts the amount of data you can upload in one file. Though the
...
if there are other users doing things in parallel. Hence EPAAS restricts the
...
EPAAS to update various data. Any spreadsheet file from popular spreadsheet
...
####Help Video on Importing Data in EPAAS from Spreadsheet file
