...
taxes correctly, they get very unhappy. Ok, philosophy aside, EPAAS allows
...
<img class="screenshot" alt="Item Tax" src="{{docs_base_url}}/assets/img/taxes/item-tax.png">
  ...
  * **Inclusive and Exclusive Tax**: EPAAS allows you to enter Item rates which are tax inclusive.
...
The way EPAAS sets up taxes is via templates. Other types of charges that
