...
The terminology of 'Warehouse" in EPAAS is a bit broader though and maybe can be 
...
In EPAAS, every Warehouse must belong to a specific company, to maintain
...
> Note: EPAAS system maintains stock balance for every distinct combination
