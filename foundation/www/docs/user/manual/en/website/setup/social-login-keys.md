...
Social Login enables users to login to EPAAS via their Google, Facebook or GitHub account.

### Enabling Social Logins.

Checkout the following Video Tutorials to understand how to enable social logins on EPAAS
...
For Google the *Authorized redirect URI* is [yoursite]/api/method/dataent.www.login.login_via_google
