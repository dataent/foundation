...
Antes de que empieces a manejar todas tus operaciones en EPAAS, primero
...
### Fase de Prueba
  ...
  * Leer el manual
  * Crea una cuenta gratis en [https://epaas.com](https://epaas.com) (La forma más facíl de experimental).
...
Una vez ya estes falimiliarizado con EPAAS, inicia introduciendo la información real!
  ...
  * También puedes configurar una nueva cuenta en [https://epaas.com](https://epaas.com), y usa los 30 días gratis. [Encuentra mas formas de usar EPAAS](/introduction/getting-started-with-epaas)
  ...
  * Si necesitas ayuda, [puedes pagar por soporte](https://epaas.com/pricing) o [preguntar en el foro de la comunidad](https://discuss.epaas.com).
