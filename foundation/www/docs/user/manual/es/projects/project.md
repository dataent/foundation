...
El manejo de proyectos en EPAAS se hace a traves de tareas. Puedes crear un proyecto y asignar varias tareas al mismo.
...
EPAAS usa [Time Log](/docs/user/manual/en/projects/time-log.html) para hacer el seguimiento del progreso de un Proyecto.
...
EPAAS te provee con una vista para visualizar las tareas de forma calendarizada usando un Gantt Chart (Hoja de Gantt).
