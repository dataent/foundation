...
En EPAAS, puedes crear las tareas de forma independiente.
...
EPAAS usa [Time Log](/docs/user/manual/en/projects/time-log.html) para seguir el progreso de una tarea.
